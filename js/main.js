...
(function(){
  ...
  li.style.opacity='1';
  lb.style.width='180px';
  // Fade out loader quickly
  setTimeout(function(){
    ld.classList.add('gone');
    document.getElementById('hEye').classList.add('in');
    document.getElementById('hType').classList.add('in');
    setTimeout(function(){document.getElementById('hSub').classList.add('in');document.getElementById('hScrl').classList.add('in');},200);
    document.getElementById('heroImg').classList.add('in');
    document.getElementById('nav').classList.add('vis');
    var pv=document.getElementById('phoneVid');
