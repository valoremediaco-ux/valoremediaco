/* ══════════════════════════════════════════════════════════
   ...
   under a top-level folder named "Valore Media- My Work".
   Example: "Valore Media- My Work/Fashion & Beauty/rhode/rhode reel.mp4"
...
const WORK_PROJECTS = [
  // ── Fashion & Beauty ──
  {
    ...
    coverImage: "",
    heroVideo: "Valore Media- My Work/Fashion & Beauty/all-american summer/All-American Summer Reel.mp4",
  ...
  },
  {
    ...
    coverImage: "Valore Media- My Work/Fashion & Beauty/rhode/Image 1.jpg",
    heroVideo: "Valore Media- My Work/Fashion & Beauty/rhode/rhode reel.mp4",
    galleryImages: [], supportingVideos: [],
  ...
  },
  {
    ...
    coverImage: "",
    heroVideo: "Valore Media- My Work/Fashion & Beauty/vanlinker/reel1 vanlinker.mp4",
    galleryImages: [], supportingVideos: [],
  ...
  },
  {
    ...
    coverImage: "",
    heroVideo: "Valore Media- My Work/Fashion & Beauty/ft. lauderdale mag/fll mag reel.mp4",
    galleryImages: [], supportingVideos: [],
    services: ["Content Creation", "Photography"]
  },
  {
    ...
    coverImage: "",
    heroVideo: "Valore Media- My Work/Fashion & Beauty/altar'd state x as revival/Altard State BTS vs Final Reel.mp4",
    galleryImages: [], supportingVideos: [],
  ...
  },
  {
    ...
    coverImage: "",
    heroVideo: "Valore Media- My Work/Lifestyle & Influencer Marketing/Commercial BTS/tom brady x ferrero.mp4",
    galleryImages: [], supportingVideos: [],
    services: ["Content Creation", "Video Editing"]
  },
  ...
  // ── Events ──
  {
    ...
    coverImage: "Valore Media- My Work/Events/NYFW/Product Marketing/runway7 merch/cafenyfw1.jpg",
    heroVideo: "Valore Media- My Work/Events/NYFW/Product Marketing/runway7 merch/runway7 merch.mp4",
    galleryImages: [], supportingVideos: [],
  ...
  },
  {
    ...
    coverImage: "Valore Media- My Work/Events/Miami Swim Week/image1msw.jpg",
    heroVideo: "Valore Media- My Work/Events/Miami Swim Week/miami swim week reel.mp4",
    galleryImages: [], supportingVideos: [],
  ...
  },
  {
    ...
    coverImage: "",
    heroVideo: "Valore Media- My Work/Events/FLLFW/fllfw runway.mp4",
    galleryImages: [], supportingVideos: [],
    services: ["Content Creation", "Video Editing"]
  },
  ...
  // ── Kids Brands ──
  {
    ...
    coverImage: "",
    heroVideo: "Valore Media- My Work/Kids Brands/lola & the boys/campaigns/GRWM final.mp4",
    galleryImages: [], supportingVideos: [],
    services: ["Content Creation", "Photography", "Video Editing"]
  },
  {
    ...
    coverImage: "",
    heroVideo: "Valore Media- My Work/Kids Brands/lola & the boys/in-store/cutest kids store.mp4",
    galleryImages: [], supportingVideos: [],
    services: ["Content Creation", "Photography"]
  },
  {
    ...
    coverImage: "",
    heroVideo: "Valore Media- My Work/Kids Brands/rooie/rooie fun reel.mp4",
    galleryImages: [], supportingVideos: [],
  ...
  // ── Lifestyle & Hospitality ──
  {
    ...
    coverImage: "Valore Media- My Work/Lifestyle & Influencer Marketing/Matias/matiasimage1.png",
    heroVideo: "Valore Media- My Work/Lifestyle & Influencer Marketing/Matias/matias reel.mp4",
    galleryImages: [], supportingVideos: [],
  ...
  },
  {
    ...
    result: "65k+ views",
    coverImage: "",
    heroVideo: "Valore Media- My Work/Lifestyle & Influencer Marketing/Sammis Reyes/sammis reyes reel.mp4",
    galleryImages: [], supportingVideos: [],
    services: ["Content Creation", "Video Editing"]
  },
  {
    ...
    coverImage: "",
    heroVideo: "Valore Media- My Work/Lifestyle & Influencer Marketing/Alexis Fleming/alexis reel.mp4",
    galleryImages: [], supportingVideos: [],
    services: ["Content Creation"]
  },
  {
    ...
    coverImage: "Valore Media- My Work/Lifestyle & Influencer Marketing/myhotbod/Carousel/1.png",
    heroVideo: "Valore Media- My Work/Lifestyle & Influencer Marketing/myhotbod/adjusted story pilates essentials.mp4",
    galleryImages: [], supportingVideos: [],
    services: ["Content Creation", "Photography", "Video Editing"]
  }
];
